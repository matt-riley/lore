...
- In `website/`, use Node 24.0.0+ and pnpm 12.3.2: `pnpm install --frozen-lockfile`, then `pnpm dev`. Validate with `pnpm check`, `pnpm test`, `pnpm build`, and `pnpm check:links`.
