...
- In `website/`, use Node 22.12+ and pnpm 11.25.0: `pnpm install --frozen-lockfile`, then `pnpm dev`. Validate with `pnpm check`, `pnpm test`, `pnpm build`, and `pnpm check:links`.
