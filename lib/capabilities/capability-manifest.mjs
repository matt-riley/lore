...
const CAPABILITY_SPECS = [
  ...
  },
  {
    ...
    support: {
      ...
      notes: "Defaults to a read-only preview. Applying requires the exact preview planFingerprint; creates a validated snapshot and retains suppression and source boundaries.",
      rolloutFlags: [],
    },
  },
  {
    ...
    support: {
      status: "experimental",
      category: "Memory administration",
      notes: "Deterministic and bounded. Missing source and ambiguous provenance remain unresolved; applying requires the exact preview planFingerprint.",
      rolloutFlags: [],
    },
  },
  {
    ...
    support: {
      status: "experimental",
      category: "Memory administration",
      notes: "Requires explicit memoryIds or repository selection. Applying requires the exact preview planFingerprint and creates a validated recovery snapshot; this is not secure erasure.",
      rolloutFlags: [],
    },
  },
  {
