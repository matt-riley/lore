...
const CAPABILITY_SPECS = [
  {
    ...
    support: {
      ...
      notes: "Overview of DB health, row counts, latency metrics, and maintenance state. CLI / `/lore` / `lore tool` aliases for one deprecation cycle: `memory_status`.",
      rolloutFlags: [],
    },
  },
  {
  ...
  },
  {
    ...
    support: {
      ...
      notes: "Triggers a maintenance sweep (dry-run or live), reports automated memory hygiene, or rolls back one exact `auto-hygiene:*` marker with an audit artifact. CLI / `/lore` / `lore tool` aliases for one deprecation cycle: `maintenance_schedule_run`.",
      rolloutFlags: [],
    },
  },
  {
  ...
  },
  {
    ...
    support: {
      status: "supported",
      category: "Core memory verbs",
      notes: "Primary retain verb. Persists a memory with scope, category, and optional domain association. CLI / `/lore` / `lore tool` aliases for one deprecation cycle: `lore_save`, `memory_save`.",
  ...
  },
  {
    ...
    support: {
      status: "supported",
      category: "Core memory verbs",
      notes: "Keyword search over the derived semantic-memory store. Meaning-based (vector) search is available via `lore_recall` when embeddings are configured. CLI / `/lore` / `lore tool` aliases for one deprecation cycle: `memory_search`.",
      rolloutFlags: [],
    },
  },
  {
    ...
    support: {
      status: "supported",
      category: "Status and diagnostics",
      notes: "Explains what context would be injected for a given prompt and why. CLI / `/lore` / `lore tool` aliases for one deprecation cycle: `memory_explain`.",
      rolloutFlags: [],
    },
  },
  {
    ...
    support: {
      status: "supported",
      category: "Status and diagnostics",
      notes: "Validates DB integrity and schema parity. CLI / `/lore` / `lore tool` aliases for one deprecation cycle: `memory_validate`.",
      rolloutFlags: [],
    },
  },
  {
  ...
  },
  {
    ...
    support: {
      status: "supported",
      category: "Core memory verbs",
      notes: "Soft-deletes a memory by ID. Superseded rows and related residual data may remain for provenance and recovery; this is not secure erasure. CLI / `/lore` / `lore tool` aliases for one deprecation cycle: `memory_forget`.",
      rolloutFlags: [],
    },
  },
  {
    ...
    support: {
      ...
      notes: "Defaults to a read-only preview. Repository selects the manual replacement destination. Apply requires planFingerprint, preserves expiry unless changed, and creates a validated snapshot. CLI / `/lore` / `lore tool` aliases for one deprecation cycle: `memory_correct`.",
      rolloutFlags: [],
    },
  },
  {
    ...
    support: {
      status: "experimental",
      category: "Memory administration",
      notes: "Deterministic complete-source repair, bounded to 32 MiB per source and the preview candidate limit. Missing, incomplete, or ambiguous sources remain unresolved. Apply requires planFingerprint and actionable selectedCandidateIds. CLI / `/lore` / `lore tool` aliases for one deprecation cycle: `memory_repair`.",
      rolloutFlags: [],
    },
  },
  {
  ...
  },
  {
    ...
    support: {
      status: "experimental",
      category: "Self-diagnostics and proposals",
      notes: "Generates a structured health report. Requires `loreDoctor` and `evolutionLedger` rollout flags. CLI / `/lore` / `lore tool` aliases for one deprecation cycle: `memory_doctor_report`.",
