  ...
  switch (routeCandidate.route) {
    ...
    case "skill":
      if (promptProfile.promptRewriteIntent && selectedTarget?.targetName === "reverse-prompt") {
        heuristicScore += 18;
        reasons.push("Explicit prompt-sharpening requests should prefer the reverse-prompt skill.");
      }
    ...
    case "agent":
      if (promptProfile.promptRewriteIntent && promptProfile.hasReversePromptSkill) {
        heuristicScore -= 18;
        reasons.push("Explicit prompt-sharpening requests should stay on the skill workflow path instead of agent delegation.");
      }
      if (explicitIntentScore > 0) {
        heuristicScore += 8 + explicitIntentScore;
