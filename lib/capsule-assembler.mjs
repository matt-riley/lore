...
export async function assembleMemoryCapsule({
  ...
  if (trace) {
    ...
    trace.lookups.onboarding = onboardingSection.trace;
  ...
  if (onboardingSection.text) {
    sections.push(onboardingSection.text);
    totalTokens += estimateTokens(onboardingSection.text);
    recordOutputSection(trace, {
    ...
    trace.omissions.push({ stage: "onboarding", reason: onboardingSection.trace.reason });
  }
