...
import { QUERY_ALIASES, STOPWORDS, inferDateFromPrompt, lookupAliasTerms } from "../utils/query-normalizer.mjs";
...
export function extractQueryTerms(prompt) {
  ...
  for (const term of directTerms) {
    ...
    for (const alias of lookupAliasTerms(QUERY_ALIASES, term)) {
