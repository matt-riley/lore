...
export class LoreDb {
   ...
   */
  listSemanticMemoriesForEmbedding({ types = [], scopes = [], repository = null, includeOtherRepositories = false, transferableFallback = false, limit = 256, offset = 0, stableOrder = false, now = new Date() } = {}) {
    this.ensureOpen();
    const params = [];
