...
export class LoreDb {
  ...
  searchSemantic({
    ...
    const suppressionRows = this.db.prepare(`
   ...
   */
  listSemanticMemoriesForEmbedding({ types = [], scopes = [], repository = null, includeOtherRepositories = false, limit = 256, offset = 0, now = new Date() } = {}) {
    this.ensureOpen();
    const params = [];
