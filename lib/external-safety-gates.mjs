 ...
 * that can be reported via existing Lore tooling surfaces.
 */

const SAFETY_GATE_MUTABILITY = Object.freeze({
  READ_ONLY: "read_only",
...
const SAFETY_GATE_REVERSIBILITY = Object.freeze({
...
const SAFETY_GATE_SCOPE = Object.freeze({
  ISOLATED: "isolated",
...
const SAFETY_GATE_SERVICE_TRUST = Object.freeze({
  TRUSTED: "trusted",
 ...
 * @returns {object}
 */
function classifySafetyGateAction(action = {}, index = 0) {
