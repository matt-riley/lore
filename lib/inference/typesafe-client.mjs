...
const DEFAULT_TYPESAFE_TIMEOUT_MS = 10000;
...
function redactSecrets(text, apiKey) {
  ...
  return output
    ...
    .replace(/\b(?:sk-[A-Za-z0-9_-]{8,}|apikey_[A-Za-z0-9]{8,}|gh[pousr]_[A-Za-z0-9]{8,}|xox[baprs]-[A-Za-z0-9-]{8,}|AIza[0-9A-Za-z_-]{10,}|AKIA[0-9A-Z]{8,}|sk_live_[A-Za-z0-9]{8,})/g, "[redacted]");
}
