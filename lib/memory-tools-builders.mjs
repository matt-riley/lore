...
import { buildMaintenanceScheduleRunTool as buildMaintenanceScheduleRunToolWithContext } from "./memory-tool-builder-maintenance-schedule-run.mjs";
...
function buildMaintenanceScheduleRunTool(getRuntime) {
  return buildMaintenanceScheduleRunToolWithContext(getRuntime, {
    toolDef,
    ensureArray,
    formatMaintenanceReport,
    getMaintenanceStatus,
