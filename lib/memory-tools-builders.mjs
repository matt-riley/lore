...
const {
  ...
  IMPROVEMENT_THEME_DERIVERS,
  deriveImprovementFallbackTheme,
  deriveImprovementTheme,
  formatIntegrityIssues,
  formatProposalGenerationReport,
  ...
  PORTABLE_BUNDLE_EXPORT_ACTION,
  CAPABILITY_INVENTORY_ACTIONS,
  normalizePortableBundleAction,
  ...
  validateScopeOverrideRequest,
  previewScopeOverride,
  applyScopeOverride,
  buildOnboardingProfileArgs,
  ...
  getReflectionDomainKey,
  getObservationPersistSkipReason,
  buildObservationUpsertInput,
  maybePersistReflectionObservation,
  normalizeBackfillRequest,
  PORTABLE_BUNDLE_VERSION,
  summarizeImprovementClusters,
  sha256,
  PORTABLE_BUNDLE_TYPE,
  formatPortableBundleReport,
...
const {
  ...
  buildReflectionHeaderLines,
  buildReflectionInsightLines,
  buildReflectionEvidenceLines,
  formatReflectionFactLines,
  formatReflectionSourceAccountingLines,
  buildReflectionLookupCoverageLines,
  formatReflectionLookupLines,
  formatReflectionLookupSamples,
  formatAuditRows,
  formatScopePreview,
  formatBackfillRunRows,
  formatBackfillItems,
  formatBackfillProgressKeyValues,
  formatControlledBackfillPreview,
  determineMaintenancePhase,
  summarizeMaintenanceProgress,
  formatControlledBackfillRun,
  runControlledBackfillPreview,
  runControlledBackfillStart,
  runControlledBackfillResume,
  runControlledBackfillRestore,
  runControlledBackfillAction,
  formatBackfillStatus,
  runLegacyBackfill,
  compareOverlayState,
  formatWorkstreamOverlayStatus,
  formatLatencyMetric,
  formatLatencyMetricLine,
  normalizeLatencyMetric,
  formatTraceRecorderRoutes,
  formatTraceRecorderLookups,
  formatTraceRecorderPatterns,
  formatActivityStates,
  formatActivityState,
  formatRetrievalTraceSampleRows,
  formatTrajectoryArtifactRows,
  formatIntentJournalRows,
  formatDoctorReport,
  formatDoctorSafetyGateSection,
  formatReviewGateReport,
  MEMORY_STATUS_IDENTITY_LINE_READERS,
  ...
  MEMORY_STATUS_IMPROVEMENT_FIELDS,
  MEMORY_STATUS_TRACE_ARTIFACT_FIELDS,
  formatStatusFieldLines,
  buildMemoryStatusImprovementLines,
  buildMemoryStatusTraceArtifactLines,
  buildMemoryStatusMetricLines,
  formatTraceRecorderHooks,
  formatTraceLookupSamples,
  formatTracePromptNeedLines,
  formatRecentTraceLookupLines,
  buildRecentTraceHeaderLines,
  formatRecentTraceList,
  formatRecentTraceValue,
  buildRecentTraceRoutingLines,
  formatRecentTraceOptionalLines,
  formatRecentTraceRecord,
  formatRecentTraceRecords,
  formatMaintenanceTaskState,
  formatMaintenanceRunRows,
  MAINTENANCE_TASK_SUMMARY_FIELDS,
  buildMaintenanceTaskSummaryFields,
  formatMaintenanceTaskResult,
...
function buildMemoryCapabilityInventoryTool(getRuntime) {
