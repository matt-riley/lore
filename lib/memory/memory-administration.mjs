...
function makePlan(owner, input) {
  ...
  const report = {
    ...
    selectors: {
      ...
      repositoryMappings: request.repositoryMappings,
      scope: request.scope,
      includeDependentAggregates: request.includeDependentAggregates,
      limit: request.limit,
    },
...
const previewMemoryCorrection = bindPreview("correct");
const previewMemoryRepair = bindPreview("repair");
const previewMemoryPurge = bindPreview("purge");
const applyMemoryCorrection = bindApply("correct");
const applyMemoryRepair = bindApply("repair");
const applyMemoryPurge = bindApply("purge");
