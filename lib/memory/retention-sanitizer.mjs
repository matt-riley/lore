...
const AGENTS_MD_INSTRUCTIONS_HEADING = /^# AGENTS\.md instructions for .+$/gm;
...
export function stripInjectedContext(value) {
  ...
  // Remove every injected AGENTS.md heading while keeping surrounding user text.
  text = text.replace(AGENTS_MD_INSTRUCTIONS_HEADING, "");
