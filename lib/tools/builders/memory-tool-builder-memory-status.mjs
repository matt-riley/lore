export function buildMemoryStatusTool(getRuntime, context) {
  ...
  return toolDef("lore_status", {
    handler: async (args, invocation) => {
      ...
      const captureHealth = runtime.db.listCaptureHealth?.({ repository: runtime.repository }) ?? [];
      ...
      const lines = [
        ...
        ...buildMemoryStatusCaptureHealthLines(captureHealth),
