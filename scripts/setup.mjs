...
try {
  ...
  for (let i = 0; i < args.length; i++) {
    if (args[i] === "--yes") options.yes = true;
      ...
      console.log("Usage: npm run setup -- [--clients copilot,pi,codex,claude,antigravity|all] [--yes] [--dry-run]\nDetects clients on PATH and installs globally. Without flags, choose clients and confirm interactively.");
      process.exit(0);
