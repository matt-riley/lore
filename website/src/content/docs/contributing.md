...
Lore is plain ESM with no build step. Use the Node.js and pnpm versions pinned in the root and website `package.json` manifests for development dependencies and website commands. If you want to run the checkout as a live Copilot extension, preview and then run the development installer:
